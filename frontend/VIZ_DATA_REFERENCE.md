...
white/grayscale radial glow like `/assets/glow.png`), plus **Cohort glow size**, **α**, **onset** +
**fade** (so it eases in instead of popping), and **tween** — the glow *eases* to its new
